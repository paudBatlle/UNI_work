...
% gt = imread('camel_00000.png');
% input_image = imread('camel_00000.jpg');
gt = imread('flamingo_00000.png');
input_image = imread('flamingo_00000.jpg');
figure(1);
imshow(input_image);
...
error = immse(uint8(BW*255),gt)
perrer = psnr(uint8(BW*255),gt)