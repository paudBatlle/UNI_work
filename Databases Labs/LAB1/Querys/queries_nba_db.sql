...
-- q12: El valor d'aquesta query és 0 perquè a l'hora d'exportar les dades el player_def.csv té algún problema (Tot i ser les dades copiades de l'arxiu ORIGINAL sense el títol de les taules)
select P_Name, Surname,  Nationality from Person p, Player pl where (pl.Year_pro = 2020 or pl.Year_pro = 2021) and p.ID_Card = pl.Player_id and pl.University = NULL;
